...
<head>
    ...
    <title>CyberPersonnel Manager | Ajouter une personne</title>
    ...
    <style>
        ...
        * {
        ...
        @keyframes successPulse {
            ...
            50% {
                box-shadow: 0 0 0 1px var(--success-color), 0 0 10px var(--success-glow);
            }
        }
    ...
    <div class="container">
        <header>
            ...
            <nav class="nav-links">
                ...
                <a href="#" class="nav-link active"><i class="fas fa-user-plus"></i> ADD</a>
            </nav>
        </header>
        
        <main>
            <h1 class="page-title"><i class="fas fa-user-plus"></i> ADD_PERSON</h1>
            
            <div class="form-container">
                <div class="form-header">
                    <i class="fas fa-id-card"></i>
                    <h2>NOUVELLE_FICHE</h2>
                    <p>CREATE_NEW_PROFILE</p>
                </div>
                
                <div class="creation-guidance">
                    <strong>> GUIDANCE:</strong> REMPLISSEZ TOUS LES CHAMPS POUR CRÉER UN NOUVEAU PROFIL
                </div>
                ...
                <form action="persons" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control" required placeholder="EX: JEAN_DUPONT" />
                        <span class="form-hint">ENTREZ_LE_NOM_COMPLET</span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="age" name="age" class="form-control" required min="1" max="120" placeholder="EX: 28" />
        ...
        <footer>
            <p class="footer-text">CYBER_PERSONNEL v2.1 > ADD_VIEW > [${currentDate}]</p>
        </footer>
    </div>
</body>
</html>